        ...
        <div class="row">
                ...
                <div class="container">
                    ...
                    <div class="row text-center p-4 my-4">
                        <h5><a href="employeedash.php" style="font-family: 'New York Large'" class="link-underline link-underline-opacity-0 text-dark">Order List</a></h5>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col container px-4 pt-3">
                            ...
                            <div class="row">
                                <p class="text-muted">Description: <?php echo $fieldname_ac['description']; ?><br>Price: <?php echo $fieldname_ac['total_price']; ?></p>
                            </div>
                            <div class="row align-items-center">
                                ...
                                <div class="col-2 text-end">
                                    <form method="POST" action="">
                                        ...
                                        <button type="submit" name="toggle_availability" class="rounded-3 text-white status-btn <?php echo $btn_class; ?>">
