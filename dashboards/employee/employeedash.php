...
<style>
    ...
    .order-scrollbox {
        ...
        /* Fixes the box size */
        overflow-y: auto;
        /* Automatically creates vertical scrollbar if needed */
        overflow-x: hidden;
        /* Prevents awkward side-scrolling */
        padding-bottom: 15px;
    }
                ...
                <div class="container">
                    ...
                    <div class="row text-center p-4 my-4">
                        <h5><a href="products.php" style="font-family: 'New York Large'"
                                class="link-underline link-underline-opacity-0 text-dark">Product Availability</a></h5>
                    </div>
                </div>
            </div>
            <div class="col-9">
                                    ...
                                    while ($order = mysqli_fetch_assoc($pending_result)) {
                                        ...
                                        <div class="row bg-white rounded-3 border mx-3 my-2 px-3 py-2">
                                            <div class="container">
                                                <div class="row">
                                                    <div class="col">
                                                        <h5 class="card-title">Customer ID: <?php echo $order['user_id']; ?>
                                                        </h5>
                                                ...
                                                <div class="row mt-2">
                                                    <div
                                                        class="col-12 text-end d-flex align-items-center justify-content-end gap-2">
                                                        <form method="POST" action="">
                                                            <input type="hidden" name="order_id"
                                                                value="<?php echo $order['order_id']; ?>">
                                                            <button type="submit" name="complete_order"
                                                                class="btn rounded-3 complete">Complete Order</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
