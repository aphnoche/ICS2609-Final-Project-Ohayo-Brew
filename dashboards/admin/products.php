            ...
            <div class="row bg-white rounded-3 border mx-3 my-2 px-3 py-2">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-2 border bg-dark p-2 rounded-3 text-center d-flex align-items-center justify-content-center" style="height: 100px;">
                            <?php 
                            ...
                            ?>
                                <img src="<?php echo $image_path; ?>" alt="Product" style="max-height: 100%; max-width: 100%; object-fit: contain;">
                            <?php else: ?>
                        ...
                        <div class="col container px-4 pt-1">
                            ...
                            <div class="row">
                                <p class="text-muted mb-2">Description: <?php echo $fieldname_ac['description']; ?><br>Price: ₱<?php echo $fieldname_ac['total_price']; ?></p>
                            </div>
                            <div class="row align-items-center">
                                <div class="col-8"></div>
                                <div class="col-2 text-end">
                                    <a href="editproduct.php?id=<?php echo $fieldname_ac['product_id']; ?>&name=<?php echo $fieldname_ac['product_name']; ?>" class="btn rounded-3 Edit btn-sm">Edit/Remove</a>
                                </div>
                                <div class="col-2 text-end">
                                    <form method="POST" action="">
                                        <input type="hidden" name="product_id" value="<?php echo $fieldname_ac['product_id']; ?>">
                                        <input type="hidden" name="current_status" value="<?php echo $prod_status; ?>">
                                        <button type="submit" name="toggle_availability" class="rounded-3 text-white status-btn btn-sm <?php echo $btn_class; ?>">
