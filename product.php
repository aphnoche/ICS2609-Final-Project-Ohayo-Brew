...
<head>
    ...
    <style>
        ...
        .product-price-detail { 
            ...
            .temperature-toggle, .size-toggle { 
                display: flex; 
                gap: 12px; 
                margin-bottom: 25px; 
            }
        ...
        .footer-logo-img { 
            max-width: 130px; height: auto; margin-bottom: 12px; 
        }
        ...
        <div class="row g-5">
            ...
            <div class="col-12 col-md-7">
                <form id="orderForm" method="POST">
                    ...
                    <div class="row">
                        <div class="col-3 option-description"><p class="product-description">Temperature:</p></div>
                        <div class="col-3 option-description"><p class="product-description">Size:</p></div>
                    </div>
                        ...
                        <div class="col-3 size-toggle">
                            <?php
                                ...
                                while ($row = mysqli_fetch_assoc($size_result)) {
                                    if (strtolower($row['size_name']) == 'regular') $reg_price = $row['price'];
                                    if (strtolower($row['size_name']) == 'large') $large_price = $row['price'];
                                }
                            ?>
                            <button type="button" class="btn-temp btn-temp-solid" data-size="Regular" data-price="<?php echo $reg_price; ?>">Regular</button>
                            <button type="button" class="btn-temp btn-temp-outline" data-size="Large" data-price="<?php echo $large_price; ?>">Large</button>
                        </div>
                    </div>
                    ...
                    <div class="addons-grid">
                        ...
                        ?>
                            <label class="addon-capsule" style="cursor: pointer;">
                                <input type="checkbox" name="addons[]" value="<?php echo $addon['addon_id']; ?>" data-price="<?php echo $addon['addon_price']; ?>" class="addon-checkbox" style="display:none;">
                                <span><?php echo $addon['addon_name']; ?> (P<?php echo number_format($addon['addon_price'], 2); ?>)</span>
                    ...
                    <textarea class="notes-textarea" name="notes" placeholder="Any specifications? (e.g., less sweet, more ice)"></textarea>
