...
<body>
    ...
    <div class="container-navbar"> <!-- html navigation bar -->
        <div class="navbar">
            <div class="logo">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-1 d-none d-md-block sidebar-nav-container"> <!-- html sidebar -->
                <div class="sidebar-nav">
                    <a href="noacchome.php#espresso"><img src="images/category/espresso-crafts.png" class="sidebar-img">
                        <p class="sidebar-text">Espresso Crafts</p>
                    </a>
                    <a href="noacchome.php#milk"><img src="images/category/tea-milk-crafts.png" class="sidebar-img">
                        <p class="sidebar-text">Milk Crafts</p>
                    </a>
                    <a href="noacchome.php#tea"><img src="images/category/tea-milk-crafts.png" class="sidebar-img">
                        <p class="sidebar-text">Tea Crafts</p>
                    </a>
                    <a href="noacchome.php#ice-blended"><img src="images/category/ice-blended.png" class="sidebar-img">
                        <p class="sidebar-text">Ice Blended Crafts</p>
                    </a>
                    <a href="noacchome.php#matcha"><img src="images/category/matcha-crafts.png" class="sidebar-img">
                        <p class="sidebar-text">Matcha Crafts</p>
                    </a>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-12 p-0">
                        <div class="cafe-banner">
                            <img src="images/home-heading.jpg" alt="Cafe Interior"
                                style="width: 100%; height: 100%; object-fit: cover; border-bottom-left-radius: 40px; border-bottom-right-radius: 40px;">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($americano_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-espresso" style="opacity: 0.5;">
                                    ...
                                    <div class="product-title"><?php echo $americano_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($americano_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-espresso">
                                        <div class="card-img-box">
                                            <img src="dashboards/admin/images/<?php echo basename($americano_row['image']); ?>"
                                                alt="Americano">
                                        </div>
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($latte_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-espresso" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($latte_row['image']); ?>"
                                            alt="Americano">
                                    </div>
                                    <div class="product-title"><?php echo $latte_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($latte_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-espresso">
                                        <div class="card-img-box">
                                            <img src="dashboards/admin/images/<?php echo basename($latte_row['image']); ?>"
                                                alt="<?php echo $latte_row['product_name']; ?>">
                                        </div>
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($spanish_latte_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-espresso" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($spanish_latte_row['image']); ?>"
                                            alt="<?php echo $spanish_latte_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $spanish_latte_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($spanish_latte_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-espresso">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($dark_mocha_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-espresso" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($dark_mocha_row['image']); ?>"
                                            alt="<?php echo $dark_mocha_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $dark_mocha_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($dark_mocha_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-espresso">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($strawberry_milk_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-milk" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($strawberry_milk_row['image']); ?>"
                                            alt="<?php echo $strawberry_milk_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $strawberry_milk_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($strawberry_milk_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($white_chocolate_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-milk" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($white_chocolate_row['image']); ?>"
                                            alt="<?php echo $white_chocolate_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $white_chocolate_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($white_chocolate_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-milk">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($yoghurt_peach_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-tea" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($yoghurt_peach_row['image']); ?>"
                                            alt="<?php echo $yoghurt_peach_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $yoghurt_peach_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($yoghurt_peach_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($strawberry_black_tea_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-tea" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($strawberry_black_tea_row['image']); ?>"
                                            alt="<?php echo $strawberry_black_tea_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $strawberry_black_tea_row['product_name']; ?>
                                        <span class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($strawberry_black_tea_price_row['price'], 2); ?>
                                    </div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($peach_mango_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-ice-blended" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($peach_mango_row['image']); ?>"
                                            alt="<?php echo $peach_mango_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $peach_mango_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($peach_mango_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($mixed_berries_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-ice-blended" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($mixed_berries_row['image']); ?>"
                                            alt="<?php echo $mixed_berries_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $mixed_berries_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($mixed_berries_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-ice-blended">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($double_choco_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-ice-blended" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($double_choco_row['image']); ?>"
                                            alt="<?php echo $double_choco_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $double_choco_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($double_choco_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-ice-blended">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($ohayo_uji_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-matcha" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($ohayo_uji_row['image']); ?>"
                                            alt="<?php echo $ohayo_uji_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $ohayo_uji_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($ohayo_uji_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($ohayo_hojicha_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-matcha" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($ohayo_hojicha_row['image']); ?>"
                                            alt="<?php echo $ohayo_hojicha_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $ohayo_hojicha_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($ohayo_hojicha_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-matcha">
                        ...
                        <div class="col-6 col-sm-4 col-md-3">
                            ...
                            <?php if ($matcha_kokuto_row['availability'] == 'Unavailable') { ?>
                                <div class="menu-card bg-matcha" style="opacity: 0.5;">
                                    <div class="card-img-box">
                                        <img src="dashboards/admin/images/<?php echo basename($matcha_kokuto_row['image']); ?>"
                                            alt="<?php echo $matcha_kokuto_row['product_name']; ?>">
                                    </div>
                                    <div class="product-title"><?php echo $matcha_kokuto_row['product_name']; ?> <span
                                            class="text-danger font-weight-bold">(Sold Out)</span></div>
                                    <div class="product-price">
                                        <?php echo '₱' . number_format($matcha_kokuto_price_row['price'], 2); ?></div>
                                </div>
                            <?php } else { ?>
                                <a href="login.php" class="menu-link">
                                    <div class="menu-card bg-matcha">
